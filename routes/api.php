...
use App\Http\Controllers\Api\UninterestedController;
...
Route::prefix('course')->group(function () {
    // list videos
    Route::get('list', [VideosController::class, 'listCourse']);
    // popular video 
    Route::get('popular', [VideosController::class, 'popular']);
    // video category
    Route::get('categories/{id?}', [VideosController::class, 'getCourseCategories']);
    // video language
    Route::get('languages', [VideosController::class, 'getVideoLanguages']);
    // view the video
    Route::post('view', [VideosController::class, 'viewCourse']);
    // video comment
    Route::post('comments', [VideosController::class, 'courseComments']);
});
...
Route::middleware('auth:api')->group(function () {
    ...
    Route::prefix('video')->group(function () {
        ...
        // Add video to not intrested
        Route::post('change_interest', [UninterestedController::class, 'change_interest']);
    });
