            ...
            <div class="content-body">
                ...
                <section id="multi-column">
                    ...
                    <div class="col-lg-12 col-md-12">
                            <h4 class='breadcrumbs'>Settings / Permission / Add Role & Permission</h4>
                 </div>
                                ...
                                <div class="card-content collapse show">
                                    ...
                                    <div class="card-body card-dashboard">
                                        ...
                                        <form method="POST"
                                            ...
                                            action="{{ route('admin.v1.settings.permission.add') }}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-check-input" type="checkbox" name="permissions[]" value="{{$item->name}}" id="defaultCheck2" >
