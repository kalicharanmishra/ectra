                        ...
                        <div class="col-lg-12 col-md-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-header">
                                    ...
                                    <h6 class="mt-2"><a href="{{ route('admin.v1.tutor.edit',Auth::user()->id) }}">Edit Your Details</a>
                                        ...
                                        <table style="margin-left:40px;width:90%;" border=1 >
                                            ...
                                            <tr>
                                                ...
                                                <td><ul>
                                                            ...
                                                            <li><strong>City</strong> : {{ $users->teacher_profile->city }}</li>

                                                            <li><strong>Country</strong> : {{ $users->teacher_profile->country }}</li>
                                                ...
                                                <td><ul>
                                                            ...
                                                            <li><strong>Degree Obtained</strong> : {{ $users->teacher_profile->degree_obtained }}</li>

                                                            <li><strong>Degree Obtained From</strong> : {{ $users->teacher_profile->degree_from }}</li>

                                                            <li><strong>Pass Out Year</strong> : {{ $users->teacher_profile->passing_out }}</li>

                                                             <li><strong>Teaching Since</strong> : {{ Carbon\Carbon::parse($users->created_at)->format('Y-m-d') }}</li> 

                                                            <li><strong>Teaching Experience</strong> : {{ $users->teacher_profile->experence }} Years</li>

                                                            <li><strong>Intro</strong>  : {{ $users->teacher_profile->intro_text }}</li>

                                                            <li><strong>Profile Name</strong> : {{ $users->teacher_profile->profile_name }}</li>

                                                            <li><strong>Demo Video</strong> : <a href="{{ aws_url($users->teacher_profile->intro_video) }}" target="_blank" > Click to view</a>
                                                                        ...
                                                                        <div class="bb-video-box">
                                                                            ...
                                                                            <div class="bb-video-box-inner">
                                                                                ...
                                                                                <div class="bb-video-box-innerup">
                                                                                    ...
                                                                                    <div data-toggle="modal" data-target="#video_preview" onclick="show_prev('{{ aws_url($users->teacher_profile->intro_video) }}','{{ aws_url($users->avtars) }}')" class="theme-cl"><i class="ti-control-play"></i></div>
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($course as $key=>$courses)
                                                        ...
                                                        <tr role="row" class="odd">
                                                            ...
                                                            @php  $tech_prof=DB::table('teacher_profile')->Where('user_id', $courses->user_id)->first();
