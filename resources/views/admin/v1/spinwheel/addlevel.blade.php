                        ...
                        <div class="col-lg-12 col-md-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Add Level to activity: {{ $activity->name }}</h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body card-dashboard">
                                        <form method="POST"
                                            action="{{ route('admin.v1.spinWheel.addLevelSubmit', ['activity_id' => $activity->id]) }}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="level_name" id="level_name"
                                                    class="form-control" value="{{ old('level_name') }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="spin_reward" id="spin_reward"
                                                    class="form-control" value="{{ old('spin_reward') }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="likes" id="likes" class="form-control" value="{{ old('likes') }}">
                                                @if ($errors->has('likes'))
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="views" id="views" class="form-control" value="{{ old('views') }}">
                                                @if ($errors->has('views'))
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="invites" id="invites" class="form-control" value="{{ old('invites') }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="followers" id="followers" class="form-control" value="{{ old('followers') }}">
