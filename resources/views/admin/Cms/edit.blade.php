            ...
            <div class="content-body">
                ...
                <section id="mulit-column">
                    ...
                    <div class="col-lg-12 col-md-12">
                            <h4 class='breadcrumbs'>CMS / Edit CMS</h4></div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    ...
                                    <div class="card-body card-dashboard">
                                        ...
                                        <form action="{{ route('admin.v1.cms.update', ['id' => $edit->id]) }}" method="POST">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="title" class="form-control"
                                                            ...
                                                            value="{{ $edit->title }}" readonly="true">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="description" class="form-control description" id="description" rows="10" cols="50">{{ $edit->description }}</textarea>
